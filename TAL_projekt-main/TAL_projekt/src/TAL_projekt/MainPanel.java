...
public class MainPanel extends JPanel implements ActionListener {
    ...
    private int width = 840, height = 400;
    JTextArea input;
    ...
    public JButton createChoice(int x, int y, String actionCommand) {
...
//        System.out.println(ae.getActionCommand().toString().hashCode());
        switch ((hash = ae.getActionCommand().toString()).hashCode()) {
            case 82539:
                if (this.choice == 0) {
                    this.algorithms.algDokladny(this.getSet(), Integer.parseInt(this.sum.getText()));
                } else {
                    this.algorithms.algHeurystyczny(this.getSet(), Integer.parseInt(this.sum.getText()));
                }

                break;
            case 1146728058:
                if (hash.equals("Dokladny")) {
                    this.choice = 0;
    ...
    public ArrayList<Integer> getSet() {
        ...
        String[] inputTable = input.getText().split(",");
        for (int i = 0; i < inputTable.length; i++) {
            zbior.add(Integer.parseInt(inputTable[i]));
        }
        return zbior;
    }
    ...
    public MainPanel() {
        ...
        this.minGenerate.setText(Integer.toString(1));
